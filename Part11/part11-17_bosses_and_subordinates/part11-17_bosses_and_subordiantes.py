...
class Employee:
	...
	def add_subordinate(self, employee: "Employee"):
		"""Adds a subordinate employee to the employer's payroll."""

		self.subordinates.append(employee)


def count_subordinates(employee: Employee):
	"""Returns the number of employees under charge of "employer"."""
	employees = len(employee.subordinates)
	for subordinates in employee.subordinates:
		employees += count_subordinates(subordinates)
