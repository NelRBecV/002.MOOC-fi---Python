# DO NOT CHANGE CLASS Book!
	...
	def older_book(book1:Book,book2:Book):
      """Compares two books and prints the older one or both if their year are the same. """
	...
	if __name__=="__main__":
	    ...
	    older_book(norma,python)
	    older_book(everest,norma)
	    older_book(everest,python)
